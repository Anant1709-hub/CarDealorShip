...
// Declare missing struct and functions manually
...
public:
    void AboutUs()
    {
        ...
        std::cout << "     I am pleased to announce the release of a convenient console" << std::endl;
...
public:
    ...
    void Reciept(std::string DateTime, std::string CarNames, std::string CarColors, int Price, int Payment, int Change)
    {
        ...
        std::cout << " Address: ";
        SetConsoleTextAttribute(RecieptColor, 11);
        std::cout << "936 Road Ekdant Nagar  Jalgaon Jamod         ";
        SetConsoleTextAttribute(RecieptColor, 7);
        std::cout << "|" << std::endl;
        std::cout << "\t|                                                    |" << std::endl;
        std::cout << "\t| ";
...
int main()
{
    ...
    // system title
    system("TITLE Car Dealership Management Program By: @Anant Patil");
...
OrderCars:
    ...
    if (AccessLevel == 1)
    {
        UserTitleText.userTitleText("                        Admin Order Cars                      ", "Anant", "                             [", "]                           ");
    }
